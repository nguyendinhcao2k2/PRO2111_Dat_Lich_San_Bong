var  urlLichSu = "http://localhost:8081/api/v1/staff/lich-su-giao-dich";
$(document).ready(()=>{
...
var appLichSuGiaoDich = new Vue({
    ...
    methods:{
        ...
        searchByNamAndSdt(event){
            var  url = "http://localhost:8081/api/v1/staff/lich-su-giao-dich";
            var  urlNew ="";
            if(event.target.value == '' || event.target.value == null){
                callApiLichSuGiaoDichStaff("http://localhost:8081/api/v1/staff/lich-su-giao-dich");
                return;
            }
