...
public class DBGenerator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
       ...
       /* NuocUong nuocUong1 = new NuocUong();
        ...
        luatSan.setThongTin("<p><span style=\"color: rgb(136, 136, 136);\">Cảm ơn quý khách đã tin tưởng và sử dụng hệ thống sân bóng của chúng tôi. Chúng tôi rất vinh hạnh khi được phục vụ quý khách</span></p><p><span style=\"color: rgb(136, 136, 136);\">Để đảm bảo quý khách có thể đặt sân và sử dụng dịch vụ tại sân bóng của chúng tôi một cách an toàn và tốt nhất.</span></p><p><span style=\"color: rgb(136, 136, 136);\">Sân bóng Đồng Đế chúng tôi chuyên cung cấp các dịch vụ thể thao liên quan tới bóng đá. Sân bóng của chúng tôi đạt chuẩn FIFA mang lại sự an toàn khi thi đấu.</span></p><p><span style=\"color: rgb(136, 136, 136);\">Website \"Đặt lịch sân bóng Đồng Đế\" của chúng tôi hoạt động 24/24 quý khách có thể tự chọn giờ và đặt sân bất cứ thời gian nào.</span></p><p><br></p><h2 class=\"ql-align-center\"><strong style=\"color: rgb(29, 29, 39);\">Tuy nhiên chúng tôi có 1 số lưu ý cho quý khách như sau:</strong></h2><p class=\"ql-align-center\"><br></p><p><span style=\"color: rgb(136, 136, 136);\">1. Phần trăm tiền cọc sẽ do chủ sân quyết định(50%)( Không bao gồm dịch vụ ). Sau khi quý khách đã chuyển tiền. Hệ thống sẽ gửi thông báo đến quý khách để xác nhận quý khách đã đặt lịch thành công.</span></p><p><span style=\"color: rgb(136, 136, 136);\">2. Dịch vụ của chúng tôi sẽ hỗ trợ quý khách đổi lịch sân trước khoảng thời gian do chủ sân cung cấp đến (mặc định 1 ngày) ngày lịch đặt của quý khách.</span></p><p><span style=\"color: rgb(136, 136, 136);\">3. Khi đến sân quý khách vui lòng cung cấp mã QR check-in nhận sân. Nếu người đặt sân không có mặt tại đó quý khách vui lòng cung cấp số điện thoại người đặt để nhận sân. Mọi quyết định sẽ được đưa ra ngay thời điểm, và quyết định của chủ sân sẽ là quyết định cuối cùng.</span></p><p><span style=\"color: rgb(136, 136, 136);\">4. Nếu quý khách có nhu cầu đặt sân gấp. Chúng tôi khuyến cáo quý khách nên liên hệ tới số 0356169620 để đặt sân trực tiếp thông qua nhân viên trực tại sân.</span></p><p><span style=\"color: rgb(136, 136, 136);\">5. Nếu quý khách đã đặt cọc và hủy sân. Số tiền quý khách đã cọc sẽ không được thanh toán lại trong mọi trường hợp.</span></p><p><span style=\"color: rgb(136, 136, 136);\">6. Mọi sự việc tại sân quyết định của chủ sân là quyết định cuối cùng nhất.</span></p><p><span style=\"color: rgb(136, 136, 136);\">7. LƯU Ý: </span></p><ul><li><span style=\"color: rgb(136, 136, 136);\">Chúng tôi khuyến cáo quý khách đặt sân trên website của chúng tôi để có thể nắm được các thông tin về các ca, số sân trống dễ dàng phục vụ cho quý khách.</span></li><li><span style=\"color: rgb(136, 136, 136);\">Khi khách gọi điện nhờ nhân viên đặt lịch thì khi đổi lịch nếu có phát sinh tiền cọc thiếu thì tiền cọc đó chỉ được chuyển khoản.</span></li></ul>");
