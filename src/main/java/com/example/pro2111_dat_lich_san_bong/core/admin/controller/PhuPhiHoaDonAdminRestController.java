...
@CrossOrigin("*")
public class PhuPhiHoaDonAdminRestController {

    @Autowired
    private PhuPhiHoaDonAdminService phuPhiHoaDonAdminService;
    ...
    public ResponseEntity<?> getAll(Optional<Integer> size, Optional<Integer> page) {
        try {
            Page<PhuPhiHoaDonAdminRespone> phuPhiAdminResponses = phuPhiHoaDonAdminService.getAll(pageRequest(size, page));
            PageableObject<PhuPhiHoaDonAdminRespone> pageableObject = new PageableObject<PhuPhiHoaDonAdminRespone>(phuPhiAdminResponses);
    ...
    @PostMapping("/create")
    public BaseResponse<?> save(@RequestBody @Valid PhuPhiHoaDonAdminRequest phuPhiAdminRequest) {
        try {
            phuPhiHoaDonAdminService.create(phuPhiAdminRequest);
    ...
    @PutMapping("/update")
    public BaseResponse<?> update(@RequestBody @Valid PhuPhiHoaDonAdminRequest phuPhiAdminRequest) {
        try {
            phuPhiHoaDonAdminService.update(phuPhiAdminRequest);
            return new BaseResponse<>(HttpStatus.OK, "Ok");
        } catch (Exception e) {
            e.printStackTrace();
            return new BaseResponse<>(HttpStatus.BAD_REQUEST, "Error");
    ...
    public BaseResponse<?> delete(@PathVariable("id") String id) {
        try {
            phuPhiHoaDonAdminService.delete(id);
            return new BaseResponse<>(HttpStatus.OK, "Ok");
        } catch (Exception e) {
            e.printStackTrace();
            return new BaseResponse<>(HttpStatus.BAD_REQUEST, "Error");
