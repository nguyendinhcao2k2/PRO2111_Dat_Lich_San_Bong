...
import com.example.pro2111_dat_lich_san_bong.core.user.model.request.LichSuViTienDoiLichNhieuUserRequest;
import com.example.pro2111_dat_lich_san_bong.core.user.model.request.ViTienCocDoiLichNhieuUserRequest;
...
@Controller
@RequestMapping("/api/v1/user/thanh-toan-nhieu")
public class DoiLichNhieuUserThanhToanRestController {
    ...
    public String submidOrder(@RequestParam("amount") int orderTotal,
        ...
        baseUrl += "/api/v1/user/thanh-toan-nhieu/vnpay-payment";
